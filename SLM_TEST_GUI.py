...
def feedback(testno = 0, count = 0, initial = None, initialArray = None, threshold = 90, yLineout = 0, blur = 5, innerBlur = 15, range = 5, maxIter = 100, yshift = 4, plot = False):
    ...
    # aboveMultArray = np.multiply(aboveBlurredArray, blazedData)     # This one does not have to be used. Added for testing. Would uncomment above two lines and replace with this one.
    ...
    if count == 0:
        for i in np.arange(width):
            initialImg.putpixel((i, int(height/2-yLineout)), int(255))
        # initialImg.show()
    ...
    if plot:
        ...
        plt.plot(np.arange(width), totalMultArray[int(height/2-yLineout),:], label = "SLM Grating", color = "C2")
        plt.plot(np.arange(width), initialArray[int(height/2-yLineout),:], label = "Initial")
        plt.plot(np.arange(width), goalArray[int(height/2-yLineout),:], label = "Goal")
        # plt.plot(np.arange(width), goalArray[int(height/2-yLineout),:], label = "TEST")
        # plt.plot(np.arange(width), aboveArray[int(height/2-yLineout),:], label = "Above")
        # plt.plot(np.arange(width), belowArray[int(height/2-yLineout),:], label = "Below")
        # plt.plot(np.arange(width), aboveMaxArray[int(height/2-yLineout),:], label = "AboveMax")
        # plt.plot(np.arange(width), belowMaxArray[int(height/2-yLineout),:], label = "BelowMax")
        # plt.plot(np.arange(width), aboveMaxBlurredArray[int(height/2-yLineout),:], label = "AboveMaxBlurred")
        # plt.plot(np.arange(width), belowMaxBlurredArray[int(height/2-yLineout),:], label = "BelowMaxBlurred")
        # plt.plot(np.arange(width), belowBlurredArray[int(height/2-yLineout),:], label = "BelowBlurred")
        # plt.plot(np.arange(width), aboveMultArray[int(height/2-yLineout),:], label = "AboveMult")
        # plt.plot(np.arange(width), belowMultArray[int(height/2-yLineout),:], label = "BelowMult")
        # plt.plot(np.arange(width), totalMultArray[int(height/2-yLineout),:], label = "TotalMult", color = "yellow")
        # plt.plot(np.arange(width), diffImgArray[int(height/2-yLineout),:], label = "DiffImg", color = "yellow")
        # plt.plot(np.arange(width), aboveBlurredArray[int(height/2-yLineout),:], label = "AboveBlurred")
        # plt.plot(np.arange(width), yshiftArray[int(height/2-yLineout),:], label = "YShift", color = "red")
        # plt.plot(np.arange(width), goalArrayBlurred[int(height/2-yLineout),:], label = "GoalBlurred")
